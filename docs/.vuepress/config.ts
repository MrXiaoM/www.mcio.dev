...
const DOMAIN_NAME = 'www.mcio.dev' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      { text: '文档', link: '/' },
      { text: '主站', link: 'https://www.mcio.dev/' },
    ],
    sidebarDepth: 2, // 侧边栏显示深度，默认1，最大2（显示到h3标题）
    logo: 'https://www.mcio.dev/logo.png', // 导航栏logo
    repo: 'MrXiaoM/www.mcio.dev', // 导航栏右侧生成Github链接
    lastUpdated: false, // 开启更新时间，并配置前缀文字   string | boolean (取值为git提交时间)
    docsDir: 'docs', // 编辑的文件夹
  ...
  head: [
    ['link', { rel: 'icon', href: 'https://www.mcio.dev/favicon.ico' }], //favicons，资源放在public文件夹
    [
      'meta',
      {
        name: 'keywords',
